 ...
 *
 * <p>Deliberately not a JPA entity and deliberately not a note: this is the shape the AI layer and
 * any future caller sees, so swapping the store underneath changes nothing above it.
 *
