...
public record ChatRequest(
    @NotBlank(message = "{validation.chat.message.required}") @Size(max = 8000, message = "{validation.chat.message.size}") @Schema(example = "Summarise what I wrote about pgvector.")
        String message,
    @Schema(
